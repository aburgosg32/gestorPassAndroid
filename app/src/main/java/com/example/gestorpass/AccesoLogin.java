package com.example.gestorpass;
...
public class AccesoLogin extends AppCompatActivity {
    ...
    private final String usermaster = "70886319";
    private final String passmaster = "AbelBurgos@";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_acceso_login);
